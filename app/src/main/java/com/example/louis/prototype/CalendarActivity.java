            ...
            public void onDayClick(Date dateClicked) {
              ...
              //  System.out.println("panic boolean is: "+panicBool);
                    ...
                    if(panicBool==true && noteBool==true){
                        ...
                        if (noteBool == true) {
                            displayDataTv.setText("notes: " + noteCount + currentNoteEvent.getData().toString());
                            noteBool = false;
                            noteCount = 0;
                        }
